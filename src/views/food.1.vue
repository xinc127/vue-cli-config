    ...
    <section class="sort-container">
      ...
      <div class="sort-item">
        <div
          ...
          @click="changeType('food')"
        >
          <span :class="{ 'active-title': sortType == 'food' }">分类</span>
        </div>
        <section
          v-show="sortType == 'food'"
          class="sort-detail category-container"
        >
          <ul class="parent-ul">
            <li
              v-for="(item, index) in shopTypes"
              :key="item.id"
              @click="selectCategoryName(item.name, index)"
            >
          ...
          <ul class="child-ul">
            <li
              v-for="childItem in currentCategory"
              :key="childItem.id"
            ></li>
          </ul>
        </section>
